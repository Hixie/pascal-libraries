{$WARNINGS OFF}{$HINTS OFF}{$NOTES OFF} // part of standard distribution
{
...
begin
  ...
  if (pp^.size >= 8) then
    writeln(ptext,'First eight bytes: $', hexstr(PtrUInt(Pointer(pointer(pp)+sizeof(theap_mem_info))^), 16));
